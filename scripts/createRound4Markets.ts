...
// 2026-09-07 live OpenWeather readings, buckets centered on current temp
// (step 3, matching Round 2/3 style): New York 19, Mumbai 31, Cairo 26,
// Sao Paulo 10.
const now = Math.floor(Date.now() / 1000);
const TARGET_DATE = BigInt(now + 24 * 3_600);
const LOCK_TIME   = BigInt(now + 18 * 3_600);

const CITIES = [
  { name: "New York",  buckets: [14n, 17n, 20n, 23n] },
  { name: "Mumbai",    buckets: [26n, 29n, 32n, 35n] },
  { name: "Cairo",     buckets: [21n, 24n, 27n, 30n] },
  { name: "Sao Paulo", buckets: [5n, 8n, 11n, 14n] },
];
